---
description: Scaffold a new component folder to the frontend standard — view, hook, types, barrel — after checking what already exists.
argument-hint: "<ComponentName> [where it goes and what it does]"
